...
ActiveRecord::Schema[7.0].define(version: 2022_07_11_134931) do
  ...
  create_table "users_organizations", force: :cascade do |t|
    ...
    t.index ["user_id", "organization_id"], name: "index_users_organizations_on_user_id_and_organization_id", unique: true
